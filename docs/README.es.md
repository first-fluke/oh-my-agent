...
**El orquestador multiagente hardcore para software de nivel de producción.**
No es solo otro wrapper de chat: oh-my-agent es un arnés profesional que le da a tu asistente de IA todo un equipo de ingeniería.
