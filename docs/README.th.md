...
| 3 | `/design` | เวิร์กโฟลว์ระบบการออกแบบ 7 ขั้นตอน |
| 4 | `/plan` | PM ย่อยฟีเจอร์ของคุณออกเป็นงานย่อย (tasks) |
| 5 | `/work` | การรันเอเจนต์หลากหลายตัวแบบทีละขั้นตอน |
| 5 | `/orchestrate` | การรันเอเจนต์แบบขนานโดยอัตโนมัติ |
| 5 | `/ultrawork` | เวิร์กโฟลว์คุณภาพสูง 5 ระยะ พร้อมจุดตรวจสอบ 11 จุด |
| 6 | `/review` | ตรวจสอบความปลอดภัย + ประสิทธิภาพ + accessibility |
| 7 | `/debug` | การแก้บัคแบบมีโครงสร้างเพื่อหาสาเหตุต้นตอ |
| 8 | `/scm` | SCM + กระบวนการ Git และรองรับ Conventional Commit |
