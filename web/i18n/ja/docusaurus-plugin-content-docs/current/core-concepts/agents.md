...
| **協調** | oma-orchestration、oma-coordination | 自動および手動マルチエージェントオーケストレーション |
...
- 認証にJWT + Argon2id、認証エンドポイントにレート制限
...
**ドメイン：** 複数のAIツール（Claude、Codex、Qwen、Cursor）の会話履歴分析とテーマ別日次／期間作業サマリー。
