---
title: 使い方ガイド
description: oh-my-agentの包括的な使い方ガイド。クイックスタート、単一タスクからマルチドメインプロジェクト、バグ修正、デザインシステム、CLI並列実行、ultraworkまでの実践例を網羅します。全ワークフローコマンド、複数言語での自動検出例、全21スキルのユースケース、ダッシュボードセットアップ、主要概念、ヒント、トラブルシューティングを解説します。
---
...
3. 自然言語でやりたいことを記述。oh-my-agentが適切なエージェントにルーティングします
