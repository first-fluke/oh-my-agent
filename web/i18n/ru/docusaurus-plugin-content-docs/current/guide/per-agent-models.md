...
description: Настройте отдельного CLI-провайдера, модель и уровень рассуждений для каждого агента через . Рассматриваются agent_cli_mapping, runtime-профили, oma doctor --profile, models.yaml и лимит квоты сессии.
---
