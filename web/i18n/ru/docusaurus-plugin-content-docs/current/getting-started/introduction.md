...
- **[Агенты](/docs/core-concepts/agents)** — Подробный обзор всех 14 агентов и предполётной проверки устава
- **[Навыки](/docs/core-concepts/skills)** — Двухуровневая архитектура в деталях
- **[Рабочие процессы](/docs/core-concepts/workflows)** — Все 14 рабочих процессов с триггерами и фазами
