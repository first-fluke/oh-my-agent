...
5. **Вы координируете** — проверяете `.agents/results/` на согласованность
...
### Knowledge Base
Результаты работы агентов сохраняются в `.agents/results/`. Содержит планы, код, отчеты и заметки по координации.
...
3. **Проверяйте Knowledge Base** — проверьте `.agents/results/` на согласованность API
