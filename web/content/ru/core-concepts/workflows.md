...
**Шаги:** Языковые настройки -> Проверка статуса установки CLI -> Статус подключения MCP (Serena в режиме Command или SSE) -> Маппинг агент-CLI -> Итого -> Предложение поставить звезду репозиторию.
