...
- Some agents have additional subdirectories: `stack/` (oma-backend, generated by /stack-set), `reference/` (oma-design), `scripts/` (oma-orchestrator), `config/` (oma-orchestrator, oma-scm).
